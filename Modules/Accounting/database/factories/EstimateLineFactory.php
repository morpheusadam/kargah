...
class EstimateLineFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'description' => $this->faker->randomElement([
                'Discovery workshop and scoping',
    ...
    {
        return $this->state(fn (): array => ['estimate_id' => $estimate->id]);
    }

    /**
     * The fractional ordering key, at the column's own scale.
     *
     * decimal(20,10), built with `brick/math` for the same reason the boards do
     * it: two lines landing on the same float is two lines with no order.
     */
